...
namespace Cipa.Domain.Test.Entities
{
    public class EleicaoTest
    {
        ...
        private Usuario UsuarioPadrao => new Usuario("teste", "teste@email.com", "Teste", "Teste Cargo", EMetodoAutenticacao.Email) { Conta = ContaPadrao() };
        ...
        public void QtdaInscricoes_InscricoesCarregadas_RetornaQtda(StatusInscricao statusInscricao, int qtdaExperada)
        {
            ...
            var usuario1 = new Usuario("eleitor1", "eleitor1@email.com", "Eleitor 1", "Cargo", EMetodoAutenticacao.Email);
            var usuario2 = new Usuario("eleitor2", "eleitor2@email.com", "Eleitor 2", "Cargo", EMetodoAutenticacao.Email);
            var usuario3 = new Usuario("eleitor3", "eleitor3@email.com", "Eleitor 3", "Cargo", EMetodoAutenticacao.Email);
            var usuario4 = new Usuario("eleitor4", "eleitor4@email.com", "Eleitor 4", "Cargo", EMetodoAutenticacao.Email);
            var usuario5 = new Usuario("eleitor5", "eleitor5@email.com", "Eleitor 5", "Cargo", EMetodoAutenticacao.Email);
            var usuario6 = new Usuario("eleitor6", "eleitor6@email.com", "Eleitor 6", "Cargo", EMetodoAutenticacao.Email);
            ...
            int qtdaInscricoesAprovadas, int qtdaInscricoesPendentes, string mensagemErro)
        {
            ...
            {
                var usuario = new Usuario($"eleitor{i}", $"eleitor{i}@email.com", $"Eleitor {i}", "Cargo", EMetodoAutenticacao.Email);
            ...
            var usuarioAprovador = new Usuario("aprovador", "aprovador@email.com", "Aprovador", "Aprovador", EMetodoAutenticacao.Email);
        ...
        public void AdicionarEleitor_EleitorLoginDuplicado_ThrowsCustomException()
        {
            ...
            var usuario1 = new Usuario("eleitor1", "eleitor1@email.com", "Eleitor 1", "Cargo", EMetodoAutenticacao.Email);
            var usuario2 = new Usuario("eleitor2", "eleitor2@email.com", "Eleitor 2", "Cargo", EMetodoAutenticacao.Email);
            var usuario3 = new Usuario("eleitor1", "eleitor3@email.com", "Eleitor 3", "Cargo", EMetodoAutenticacao.Email);
        ...
        public void AdicionarEleitor_EleicaoAposEtapaVotacao_ThrowsCustomException()
        {
            ...
            var novoEleitor = new Eleitor(new Usuario("email", "email@email.com", "Teste", "Teste", EMetodoAutenticacao.Email));
            var excecao = Assert.Throws<CustomException>(() => eleicao.AdicionarEleitor(novoEleitor));
        ...
        public void AdicionarEleitor_DimensionamentoInvalido_ThrowsCustomException()
        {
            ...
            var novoUsuario = new Usuario("teste", "teste@email.com", "Eleitor 1", "Cargo", EMetodoAutenticacao.Email);
        ...
        public void FazerInscricao_EleitorJaInscrito_ThrowsCustomException()
        {
            ...
            var novoUsuario = new Usuario("eleitor1", "eleitor1@email.com", "Eleitor 1", "Cargo", EMetodoAutenticacao.Email);
            var novoEleitor = new Eleitor(novoUsuario);
        ...
        public void AtualizarInscricao_InscricaoNaoEncontrada_ThrowsCustomException()
        {
            ...
            var novoUsuario = new Usuario("eleitorteste", "eleitorteste@email.com", "Eleitor 1", "Cargo", EMetodoAutenticacao.Email);
        ...
        {
            var eleicao = CriarEleicao();
            var usuario = new Usuario("eleitor", "eleitor@email.com", "Eleitor", "Cargo", EMetodoAutenticacao.Email);
        ...
        public void ExcluirEleitor_InscricaoReprovadaEleitorJaVotou_ThrowsCustomException()
        {
            ...
            inscricao.Id = 1;
            var usuarioAprovador = new Usuario("aprovador", "aprovador@email.com", "Aprovador", "Cargo Aprovador", EMetodoAutenticacao.Email);
        ...
        {
            var eleicao = CriarEleicao();
            var usuario1 = new Usuario("eleitor1", "eleitor1@email.com", "Eleitor1", "Cargo", EMetodoAutenticacao.Email);
            var eleitor1 = new Eleitor(usuario1) { Id = 1 };
            eleicao.AdicionarEleitor(eleitor1);
            var usuario2 = new Usuario("eleitor2", "eleitor2@email.com", "Eleitor2", "Cargo", EMetodoAutenticacao.Email);
            var eleitor2 = new Eleitor(usuario2) { Id = 2 };
            eleicao.AdicionarEleitor(eleitor2);
            var usuario3 = new Usuario("eleitor3", "eleitor3@email.com", "Eleitor3", "Cargo", EMetodoAutenticacao.Email);
            var eleitor3 = new Eleitor(usuario3) { Id = 3 };
            eleicao.AdicionarEleitor(eleitor3);
